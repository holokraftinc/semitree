...
export const metadata: Metadata = pageMeta({
  title: "Learn microfluidics",
  description:
    "A zero-to-competent microfluidics curriculum in six levels — fundamentals, lab-on-chip, devices, manufacturing and applications — with worked examples and calculator links.",
  path: "/learn/microfluidics",
});

export default function LearnMicrofluidicsPage() {
  return (
    <Container className="space-y-10 py-10">
      <div className="space-y-3">
        ...
        />
        <h1 className="text-3xl font-bold tracking-tight">Learn microfluidics</h1>
